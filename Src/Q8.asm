...
jal init_array
li $a0, 0x10020000
jal exchange_following_half_words
b end
...
exchange_following_half_words_loop_start:
	...
	addi $t0, $t0, 2
	addi $t4, $t4, 4
	bne $t4, 80, exchange_following_half_words_loop_start
jr $ra
